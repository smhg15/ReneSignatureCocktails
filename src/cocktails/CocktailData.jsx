function cocktailData(cocktail){
    ...
    if (cocktail == 'aroha'){
        ...
        profileInfo:{
            title:'Aroha',
            header:'MULTIMEDIA',
            epigraph:'Cocktail con base de ron y cayena, de intensidad fuerte y picante al paladar, notas cítricas y tropicales con predominancia del mango.',
        ...
        profileInfo:{
            title:'Elixir',
            header: 'elixir.jpeg',
            epigraph:'Cocktail con base de vodka, de intensidad media al paladar. Notas de flor de sauco, manzana y cerezas.',
        ...
        profileInfo:{
            title:'Iceberg',
            header:'iceberg.jpg',
            epigraph:'Cocktail con base de ginebra y coco, de intensidad media con final seco.',
        ...
        profileInfo:{
            ...
            epigraph:'Cocktail con base de ginebra y té de frutos rojos, de intensidad media y notas dulces a frutas del bosque.',
        ...
        profileInfo:{
            ...
            epigraph:'Cocktail con base de vodka, de intensidad suave al paladar. Notas afrutadas con maracuyá, melocotón y naranja y ligeramente dulce.',
        ...
        profileInfo:{
            ...
            epigraph:'Cocktail con base de ginebra infusionada en canela y clavo de olor; de intensidad media y notas afrutadas.',
        ...
        profileInfo:{
            title:'Sicilia',
            header:'sicilia.jpeg',
            epigraph:'Cocktail con base de Crodino (bitter italiano), de intensidad fuerte y amarga debido al acompañamiento del ron. Notas cítricas y frescas.',
